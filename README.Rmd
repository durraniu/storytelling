...
{storytelling} is an R package that provide functions to use various Web APIs to:  
...
Following is an example workflow to create a story slide deck with audio: 
