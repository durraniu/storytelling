...
#' @param system_prompt Character. System prompt for the client that generates stories. Default system prompt is created with the function `storytelling::generate_story_system_prompt` that instructs the LLM to create an adventure story in a Hero's Journey structure
