...
#' @param system_prompt Character. System prompt for the client that generates prompts for creating images. Default system prompt is specified by an internal function that provides an example. See `storytelling:::generate_image_prompts_system_prompt`
...
#' generate_image_prompts(story = c("I woke up feeling tired, so I washed my face.", "Suddenly, I saw a shadow in the mirror who was jumping at me.", "I lunged on a side and the shadow was gone. It was my cat!"))
generate_image_prompts <- function(story,
  ...
  client$chat_structured(
    ...
    type = ellmer::type_array(
      paste0("Exactly ",  length(story),  " paragraphs. Each element is a paragraph."),
